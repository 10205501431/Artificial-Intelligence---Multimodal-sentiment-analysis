...
from utils.tool import data_format, read_from_file, train_val_split, save_model, write_to_file
from utils.dataset  import Processor
...
if config.fuse_model_type == 'OTE' or config.fuse_model_type == 'OutputTransformerEncoder':
    from models.OTE import Model
